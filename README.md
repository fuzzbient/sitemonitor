...
SiteMonitor is an application to monitor site up status by requesting configured URL paths and verifying contents in the response match the requred values.
