package sitemonitor.security.provider;
 ...
 * 
 * Usage:  Before connecting to an SSL server, call XTrustProvider.install().
 * Elminates the need for a trustore with a client certificate.
 */
...
public class XTrustProvider extends java.security.Provider {
	private static final long serialVersionUID = -6332346641682538312L;
		...
		javax.net.ssl.HttpsURLConnection
				.setDefaultHostnameVerifier(new javax.net.ssl.HostnameVerifier() {
					public boolean verify(String hostname,
						...
						// Change these to limit if desired.
